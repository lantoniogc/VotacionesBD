    ...
    <section class="content container-fluid">
        ...
        <!-- Form Element sizes -->
          <div class="box box-success">
                ...
                <div class="box-body">
                <form method="POST" action="{{url('admin/egresados')}}" enctype="multipart/form-data">
                @csrf
                <label>Cedula</label>
                ...
                <label>Nombre</label>
                  ...
                  <br>
                  <label>Tipo</label>
                  <input class="form-control" type="text" placeholder="Tipo" name="tipo" value="Egresado">
                  <br>
                  <label>Email</label>
                  ...
                  <br>
                  <label>Foto</label>
                  <input class="form-control" type="text" placeholder="URL Foto" name="foto">
                  <br>
                  <label>Ubicacion</label>
                  <input class="form-control" type="text" placeholder="Ubicacion" name="ubicacion">
                  <br>
                  <label>Fecha de ingreso</label>
                  <input class="form-control" type="date" placeholder="Fecha Egreso" name="fecha_egreso">
                  <br>
